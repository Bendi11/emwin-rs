...
impl TryFrom<UnparsedProductIdentifier> for ObservationalBUFRUpperAir {
    type Error = DataTypeDesignatorParseError;
    fn try_from(value: UnparsedProductIdentifier) -> Result<Self, Self::Error> {
        Ok(match value.a1 {
...
impl TryFrom<UnparsedProductIdentifier> for ObservationalBUFRSurfaceSeaLevel {
    type Error = DataTypeDesignatorParseError;
    fn try_from(value: UnparsedProductIdentifier) -> Result<Self, Self::Error> {
        Ok(match value.a1 {
...
impl TryFrom<UnparsedProductIdentifier> for ObservationalBUFROceanic {
    type Error = DataTypeDesignatorParseError;
    fn try_from(value: UnparsedProductIdentifier) -> Result<Self, Self::Error> {
        Ok(match value.a1 {
